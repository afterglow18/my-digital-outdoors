...
const LM = {
  ...
  rows: [
    ...
    { sectionTop: 0.364, shelfY: 0.522, btnCY: 0.473 },  // Row 2
    { sectionTop: 0.524, shelfY: 0.678, btnCY: 0.636 },  // Row 3
    { sectionTop: 0.694, shelfY: 0.819, btnCY: 0.804 },  // Row 4
  ],
  // Action bar
  barY:   0.840,
  barBot: 1.000,
            ...
            {!hasItems && (
              <div style={{
                ...
                <p style={{
                  ...
                  Add gear, equipment, supplies or accessories in the Gear tab first.
                </p>
              </div>
            )}
                ...
                {phase === "idle" && !isSaveOpen && (
                  <motion.button
                    ...
                    style={{
                      ...
                      border: "2.5px solid #C04800",
                      background: hasItems
                        ? "linear-gradient(to bottom, #F07030, #C04800)"
                        : "rgba(200,120,60,0.22)",
                      color: hasItems ? "#fff" : "#A04020",
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: "linear-gradient(to bottom, #F07030, #C04800)",
                        color: "#fff", fontWeight: 700, fontSize: 13, border: "1.5px solid #C04800",
