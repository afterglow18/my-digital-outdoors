...
const ROWS: { key: RowKey; btnLabel: string }[] = [
  { key: "outfits",    btnLabel: "+ ADD GEAR"        },
  { key: "beauty",     btnLabel: "+ ADD EQUIPMENT"   },
  { key: "toiletries", btnLabel: "+ ADD SUPPLIES"    },
  { key: "essentials", btnLabel: "+ ADD ACCESSORIES" },
];
...
const LM = {
  ...
  rows: [
    { sectionTop: 0.230, shelfY: 0.373, btnCY: 0.278 },  // Row 1 (top shelf)
    { sectionTop: 0.382, shelfY: 0.540, btnCY: 0.405 },  // Row 2
    { sectionTop: 0.550, shelfY: 0.704, btnCY: 0.570 },  // Row 3
    { sectionTop: 0.714, shelfY: 0.855, btnCY: 0.732 },  // Row 4
  ],
        ...
        <>
          ...
          {itemsLeft !== null && (
            <button
              ...
              style={{
                position: "absolute",
                top: pY(ir, 0.150), left: "50%", transform: "translateX(-50%)",
                zIndex: 25,
                ...
                <>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    ...
                    <button
                      ...
                      style={{
                        flex: 1, height: 40, borderRadius: 20,
                        border: "2px solid #C04800",
                        background: "linear-gradient(to bottom, #F07030, #C04800)",
